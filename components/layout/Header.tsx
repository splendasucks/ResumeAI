            ...
            {isLoaded && !isSignedIn ? (
              <>
                <SignInButton mode="redirect">
                  <span className="text-gray-800 hover:bg-primary-700/10 duration-300 focus:ring-4 focus:ring-primary-700/30 font-medium rounded-full text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none cursor-pointer">
                    Log in
                  </span>
                </SignInButton>
                <SignUpButton mode="redirect">
                  <span className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-full text-sm px-4 lg:px-5 py-2 lg:py-2.5 focus:outline-none cursor-pointer">
                    Get started
                  </span>
                </SignUpButton>
              </>
